                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        ...
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            ...
                            <p class="mb-0">Email: <strong>admin@volt.com</strong> Password: <strong>secret</strong></p>
                        </div>
                        ...
                        <div class="d-flex justify-content-center my-4">
                            ...
                            <a href="#" class="btn btn-icon-only btn-pill btn-outline-gray-500 me-2"
                                title="Google button">
                                <svg class="icon icon-xxs" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512"
                                    fill="currentColor">
                                    <path d="M488 261.8c0-17.8-1.5-35-4.3-51.6H249v97.8h134.1
                                c-5.8 31.3-23.3 57.8-49.7 75.6v62h80.5c47-43.3 74.1-107.1
                                74.1-183.8zM249 480c66.6 0 122.5-22 163.3-59.6l-80.5-62c-22.4
                                15.1-51 23.9-82.8 23.9-63.7 0-117.6-43-136.8-101.1H29.1v63.3C69.6
                                426.4 152.7 480 249 480zM112.2 303.2c-5.3-15.7-8.3-32.5-8.3-49.7s3-34
                                8.3-49.7v-63.3H29.1C10.6 174.2 0 210.1 0 248s10.6 73.8 29.1
                                107.5l83.1-52.3zM249 97.9c36.2 0 68.7 12.5 94.3 37l70.7-70.7C384.1
                                24.5 328.2 0 249 0 152.7 0 69.6 53.6 29.1 134.5l83.1 63.3C131.4
                                140.9 185.3 97.9 249 97.9z" />
                                </svg>
                            </a>
