            ...
            <div class="row justify-content-center">
                ...
                <div class="bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                    <div class="text-center text-md-center mb-4 mt-md-0">
                        <h1 class="mb-3 h3">Ganti Password</h1>
                        <p class="mb-0">Silakan masukkan password baru Anda.</p>
                    </div>
                    @if (session('status'))
                        ...
                        @csrf
                         <div class="mb-4">
                            ...
                            <div class="input-group">
                                <input type="email" class="form-control" placeholder="{{ auth()->user()->email }}" id="email" required="" disabled="">
                            </div>  
                        </div>
