<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-md-none">
    <a class="navbar-brand me-lg-5" href="@signedUrl('dashboard')">
        <img class="navbar-brand-dark" src="{{ asset('assets/img/illustrations/3dlogowotxt.webp') }}" alt="AGS logo" />
        <img class="navbar-brand-light" src="{{ asset('assets/img/illustrations/3dlogowotxt.webp') }}" alt="AGS logo" />
    </a>
...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-2 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            <li class="nav-item">
                <a href="#" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon me-3">
                        <img src="{{ asset('assets/img/illustrations/3dlogowotxt.webp') }}" height="20"
                            width="20" alt="Volt Logo">
                    </span>
                    <span class="mt-1 ms-1 sidebar-text">
                        Adidata Global Sistem
                    </span>
                </a>
            </li>
            <li class="nav-item {{ Request::segment(1) == 'dashboard' ? 'active' : '' }}">
                <a href="@signedUrl('dashboard')" class="nav-link">
            ...
            <li class="nav-item">
                <span class="nav-link collapsed d-flex justify-content-between align-items-center"
                    ...
                    <span>
                        ...
                        <span class="sidebar-text" style="color: #fb503b;">Management</span>
                    </span>
                ...
                <div class="multi-level collapse show" role="list" id="submenu-laravel" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item {{ Request::segment(1) == 'profile' ? 'active' : '' }}">
                            <a href="@signedUrl('profile')" class="nav-link">
                                <span class="sidebar-text">Profile</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::segment(1) == 'users' ? 'active' : '' }}">
                            <a href="@signedUrl('users.index')" class="nav-link">
                                <span class="sidebar-text">User management</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::segment(1) == 'roles' ? 'active' : '' }}">
                            <a href="@signedUrl('roles.index')" class="nav-link">
            ...
            <li class="nav-item {{ Request::segment(1) == 'emails' ? 'active' : '' }}">
                <a href="@signedUrl('email.index')" class="nav-link d-flex justify-content-between">
                    <span>
            ...
            <li class="nav-item {{ Request::segment(1) == 'tasks' ? 'active' : '' }}">
                <a href="@signedUrl('tasks.index')}}" class="nav-link d-flex justify-content-between">
                    <span>
            ...
            <li class="nav-item {{ Request::segment(1) == 'transactions' ? 'active' : '' }}">
                <a href="@signedUrl('transactions')" class="nav-link">
                    <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor"
                            viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item {{ Request::segment(1) == 'calendar' ? 'active' : '' }}">
                <a href="@signedUrl('calendar') }" class="nav-link d-flex justify-content-between">
                    <span>
            ...
            <li class="nav-item {{ Request::segment(1) == 'map' ? 'active' : '' }}">
                <a href="@signedUrl('map') }" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item">
                <a href="https://themesberg.com" target="_blank" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon me-2">
                        <img class="me-2" src="{{ asset('assets/img/illustrations/3dlogowotxt.webp') }}"
                            height="20" width="20" alt="Themesberg Logo">
                    </span>
